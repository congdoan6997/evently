...
const Card = ({ event, hasOrderLink, hidePrice }: CardProps) => {
  ...
  return (
    <div
      className="relative group flex min-h-[380px] w-full max-w-[400px]
    ...
    >
      ...
      <div className="flex min-h-[230px] flex-col  gap-3 p-5 md:p-4">
        {!hidePrice && (
        ...
        <div className="flex-between flex-grow w-full">
